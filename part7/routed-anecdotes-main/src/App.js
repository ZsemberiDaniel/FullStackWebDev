...
const CreateNew = (props) => {
    ...
    const handleSubmit = (e) => {
        ...
        props.setNotification(`New anecdote added: ${content.value}!`);
        history.push('/');
    };
    ...
    return (
        <div>
            ...
            <Switch>
                ...
                <Route path='/new'><CreateNew addNew={addNew} setNotification={notify} /></Route>
                <Route path='/anecdotes/:id'><DetailedAnecdote anecdote={anecdote} /></Route>
